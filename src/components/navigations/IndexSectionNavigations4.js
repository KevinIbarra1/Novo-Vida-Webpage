            ...
            <div className="flex flex-wrap items-center">
              <div className="w-auto hidden lg:block">
                <ul className="flex items-center mr-16">
                  <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">HOME</a></li>
                  <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">SERVICES</a></li>
                  <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">MEMBERSHIPS</a></li>
                  <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">ABOUT</a></li>
                  <li className="font-medium hover:text-gray-700"><a href="#" className="navTextOption">Blog</a></li>
                </ul>
              </div>
          ...
          <nav className="relative z-10 px-9 pt-8 bg-white h-full overflow-y-auto">
            <div className="flex flex-wrap justify-between h-full">
              ...
              <div className="flex flex-col justify-center py-16 w-full">
                <ul>
                  <li className="mb-12"><a className="font-medium hover:text-gray-700" href="#">HOME</a></li>
                  <li className="mb-12"><a className="font-medium hover:text-gray-700" href="#">SERVICES</a></li>
                  <li className="mb-12"><a className="font-medium hover:text-gray-700" href="#">MEMBERSHIPS</a></li>                
                  <li><a className="font-medium hover:text-gray-700" href="#">BLOG</a></li>
                  <li className="mb-12"><a className="font-medium hover:text-gray-700" href="#">ABOUT</a></li>
                </ul>
              </div>
