...
export default function MembershipsSectionNavigations1() {
    return (
        <React.Fragment>
            <>
      ...
      <div className="flex flex-wrap items-center">
        <div className="w-auto hidden lg:block">
          <ul className="flex items-center mr-16">
            <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">Features</a></li>
            <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">Solutions</a></li>
            <li className="mr-9 font-medium hover:text-gray-700"><a href="#" className="navTextOption">Resources</a></li>
            <li className="font-medium hover:text-gray-700"><a href="#" className="navTextOption">Pricing</a></li>
          </ul>
        </div>
