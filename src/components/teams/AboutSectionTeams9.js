        ...
        <section className="pt-24 pb-32 bg-white overflow-hidden">
          <div className="container px-4 mx-auto">
            ...
            <p className="text-lg text-gray-600 text-center font-medium md:max-w-xl mx-auto">
              ...
              resultados para nuestros clientes. Con pasión y profesionalismo,
              trabajamos juntos para alcanzar nuevas metas.
            </p>

            <div className="flex flex-wrap max-w-7xl mx-auto p-6 justify-center items-center">
            <div className="w-full md:w-1/2 lg:w-1/4 p-3">
                <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-2">
                    <div
                      className="w-full py-4 px-5 rounded-lg bg-white bg-opacity-10"
              ...
              <div className="w-full md:w-1/2 lg:w-1/4 p-3">
                <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
                  <img
                    className="h-full object-cover transform hover:scale-105 transition ease-in-out duration-1000"
                    src="https://static.shuffle.dev/uploads/files/6e/6e0f5129d29c66a42389554d32247ff33a40eeff/IMG-7668.jpg"
                    alt
                  />
                  <div className="absolute bottom-0 left-0 w-full p-2">
                    <div
                    ...
                    >
                      ...
                      <div className="flex wrap items-center -m-2.5">
                        ...
                        <div className="w-auto p-2.5">
                          <a
                            className="text-white hover:text-opacity-80 transition ease-in-out duration-200"
                            href="https://www.instagram.com/coach_abner_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                          >
                            <svg
                              width={17}
                              height={16}
                    ...
                    >
                      ...
                      <div className="flex wrap items-center -m-2.5">
                        ...
                        <div className="w-auto p-2.5">
                          <a
                            className="text-white hover:text-opacity-80 transition ease-in-out duration-200"
                            href="https://www.instagram.com/bereniceboada?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                          >
                            <svg
                              width={17}
                              height={16}
              ...
              <div className="w-full md:w-1/2 lg:w-1/4 p-3">
                <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-2">
                    <div
                      className="w-full py-4 px-5 rounded-lg bg-opacity-10 bg-opacity-10"
                      style={{ backdropFilter: "blur(3px)" }}
                    >
                      <h3 className="mb-1 text-lg text-white font-bold leading-snug">
                        Jane Cooper
