...
export default function AboutSectionContact11() {
  ...
  <div className="container px-4 mx-auto">
    <div className="mb-20 text-center md:max-w-xl mx-auto text-left">
      ...
      <p className="text-lg text-gray-600 font-medium leading-normal md:max-w-lg mx-auto">En Novo Vida, nos dedicamos a ayudarte a alcanzar tus metas de fitness. Visítanos en Sabana Grande y descubre nuestras instalaciones y entrenadores expertos. ¡Estamos aquí para apoyarte!
      </p>
    </div>
    <div className="flex flex-wrap xl:items-center -m-8 justify-center">
      <div className="w-full md:w-1/2 p-8">
        <div className="max-w-max mx-auto overflow-hidden rounded-3xl">
          <img className="transform hover:scale-105 transition ease-in-out duration-1000" src="https://static.shuffle.dev/uploads/files/6e/6e0f5129d29c66a42389554d32247ff33a40eeff/Screenshot-2024-06-27-at-7-36-45-PM.png" alt />
        </div>
      </div>
      <div className="p-8">
