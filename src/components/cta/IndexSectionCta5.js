...
export default function IndexSectionCta5() {
  return (
    <React.Fragment>
      <section className="relative bg-no-repeat bg-center bg-cover overflow-hidden" style={{ backgroundImage: 'url("image00022.webp")', backgroundAttachment: 'fixed', backgroundPosition: 'center', backgroundSize: 'cover' }}>
